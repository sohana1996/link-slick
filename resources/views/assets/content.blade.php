...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h3 class="pull-left noMargin">Content</h3>
                            ...
                            <form onsubmit="removeMedia(event)">
                                ...
                                <div class="modal-body">
                                    <h4 class="text-center">
                                        Are you really want to remove this Content?
                                    </h4>
                                </div>
                                <div class="modal-footer">
                                    {{ csrf_field() }}
        ...
        <script type="application/javascript" src="{{env('APP_URL')}}/js/content.js?_token={{uniqid()}}"></script>
    </div>
    {{--</home>--}}
@endsection
