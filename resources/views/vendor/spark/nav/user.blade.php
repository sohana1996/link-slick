    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid" v-if="user">
            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right nav_top_spark">
                @includeIf('spark::nav.user-right')
                <!-- Notifications -->
                    <li class="@if(isset($page['feedLoad']) && $page['feedLoad'] == 'home') active @endif"><a
                                href="{{env('APP_URL')}}/home">Dashboard</a></li>
                    <li class="@if(isset($page['feedLoad']) && $page['feedLoad'] == 'links') active @endif"><a
                                href="{{env('APP_URL')}}/links">Assets</a></li>
                    <li><a href="http://help.linkslick.com/">Help</a></li>
                    <!-- Notifications -->
                    <li>
                        <a @click="showNotifications" class="has-activity-indicator">
                            <div class="navbar-icon">
                                <i class="activity-indicator"
                                   v-if="hasUnreadNotifications || hasUnreadAnnouncements"></i>
                ...
                <div class="nav-progressBar" id="nav-progressBar"></div>
            </div>
        </div>
    </nav>
</spark-navbar>
